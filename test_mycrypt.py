...
@pytest.mark.parametrize("invalid_input", [123, b'123', [], {}])
...
@pytest.mark.parametrize("invalid_lenght", [1001, 0, 2000])
def test_invalid_lenght(invalid_lenght):
    '''Invalid lenght input should result in IndexError'''
    with pytest.raises(IndexError):
        mycrypt.encode("x"*invalid_lenght)
